...
## 🎨 Bootstrap компоненты для React

В проекте используются следующие компоненты **React Bootstrap**:

### 📱 **Навигация и Layout**
- `Nav` - Навигационные элементы
- `Navbar` - Верхняя панель навигации
- `Container` - Контейнеры для контента
- `Row` / `Col` - Сетка Bootstrap

### 🎛️ **Формы и ввод**
- `Form` - Формы
- `FormControl` - Поля ввода
- `FormSelect` - Выпадающие списки
- `InputGroup` - Группы ввода
